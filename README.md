...
![demoimage]([/media/streamlit_1](https://github.com/hala-aj/Age-and-Gender-Prediction/blob/main/media/streamlit_1.png?raw=true))
![demoimage]([/media/streamlit_2](https://github.com/hala-aj/Age-and-Gender-Prediction/blob/main/media/streamlit_2.png?raw=true))
...
![imdbimage]([/media/dataset-cover](https://github.com/hala-aj/Age-and-Gender-Prediction/blob/main/media/dataset-cover.png?raw=true))
## Project Structure
...
3. [models](): contains the binary representations of the models saved in keras
#### Huggingface model repository: https://huggingface.co/halaaj/AgeGenderModels
 ...
 *(--help/-h will give the list of arguments the script can take)*
  #### The analysis script assumes a default model directory. Moving the models will cause errors, so either keep them in place or specify both model paths.  
